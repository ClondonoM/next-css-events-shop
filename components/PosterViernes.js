...
const PosterViernes = () => {
  return (
    <div className={`${styles.poster_container} gradientColor`}>
      <p className={styles.poster_text_black_1}>VIERNES</p>
      <div className={styles.poster_banner_1}>
        <p className={styles.poster_top_text}>VIERNES</p>
      ...
      <div className={styles.poster_text_box}>
        <div className={styles.poster_text_black_2}>
          <FaRegCalendarAlt /> 06 de Mayo a las 23:00
          <hr color='black' />
        </div>
        <div className={styles.poster_text_black_2}>
          <ImTicket /> desde $850
